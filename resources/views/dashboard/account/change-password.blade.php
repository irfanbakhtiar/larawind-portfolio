            ...
            <div class="lg:px-4 lg:py-2 pt-16 rounded-lg content lg:ml-10">
                ...
                <div class="relative px-5 py-3 mb-4 overflow-x-auto bg-white rounded-lg content">
                    ...
                    @error('current_password')
                        <div id="alert-3" class="loading flex p-4 mb-4 text-red-800 rounded-lg bg-red-100 " role="alert">
                    ...
                    @enderror
                    <form method="post" action="/dashboard/account/change-password">
                        @csrf
                        <div class="mb-4">
                            <label for="password"
                                class="block mb-2 text-sm font-semibold text-gray-700 tracking-wide">Current
                                Password</label>
                            <input type="password" name="current_password" id="current_password"
                                class="shadow-sm bg-white border border-gray-200 text-gray-600 text-sm rounded-lg focus:outline-none focus:ring-1 focus:ring-primary focus:border-primary block w-full p-2.5"
                                required autocomplete="current-password" placeholder="••••••••">
                        </div>
                        <div class="mb-4">
                            <label for="password" class="block mb-2 text-sm font-semibold text-gray-700 tracking-wide">New
                                Password</label>
                        ...
                        <div class="mb-4">
                            <label for="password"
                                class="block mb-2 text-sm font-semibold text-gray-700 tracking-wide0">New
                                Confirm
                                Password</label>
