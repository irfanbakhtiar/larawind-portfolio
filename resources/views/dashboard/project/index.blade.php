            ...
            <div class="lg:px-4 lg:py-2 pt-16 rounded-lg content lg:ml-10">
                ...
                <div class="flex px-5 py-3 mb-4 text-dark rounded-lg bg-white">
                    <div class="w-full self-center lg:w-1/2">
                        <p class="text-gray-600 font-bold">Data Project</p>
                        <p class="text-gray-500 text-sm inline-block">List of data projects</p>
                    </div>
                ...
                <div class="relative overflow-x-auto rounded-lg">
                    <table class="w-full text-sm text-left text-gray-600 table-auto">
                        <thead class="text-xs text-dark uppercase shadow bg-gray-100">
                            <tr>
                                    ...
                                    <tr class="bg-white border-b hover:bg-gray-50">
                                        ...
                                        <td class="py-4 font-medium">
                                            <span class="line-clamp-1">
                                                <a href="/dashboard/project/{{ $project->slug }}" class="hover:text-primary"
                                        ...
                                        <td class="px-6 py-3 whitespace-nowrap">
                                            <a href="/dashboard/project/{{ $project->slug }}/edit"
                                    ...
                                    <div data-te-modal-dialog-ref
                                        ...
                                        <div
                                            ...
                                            <div class="p-6 text-center">
                                                ...
                                                <form action="/dashboard/project/{{ $project->slug }}" method="POST"
                                                    class="inline-table">
                                                    @method('delete')
                                                    @csrf
                                                    ...
                                                    <button data-te-modal-dismiss type="button"
                                                        class="text-gray-500 bg-white hover:bg-gray-100 rounded-full border border-gray-200 text-sm font-medium px-5 py-2.5 hover:text-dark focus:z-10 ">No,
                                                        cancel</button>
                                                </form>
                                            </div>
                                        </div>
