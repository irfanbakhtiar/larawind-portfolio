            ...
            <div class="lg:px-4 lg:py-2 pt-16 rounded-lg content lg:ml-10">
                ...
                <div class="relative px-5 py-3 mb-4 overflow-x-auto bg-white rounded-lg content">
                    ...
                    <form method="post" action="/dashboard/project" enctype="multipart/form-data">
                        ...
                        @enderror
                        @error('image')
                            <div id="alert-3" class="flex p-4 mb-4 text-red-800 rounded-lg bg-red-100 " role="alert">
                                <svg aria-hidden="true" class="flex-shrink-0 w-5 h-5" fill="currentColor" viewBox="0 0 20 20"
                                    xmlns="http://www.w3.org/2000/svg">
                                    <path fill-rule="evenodd"
                                        d="M18 10a8 8 0 11-16 0 8 8 0 0116 0zm-7-4a1 1 0 11-2 0 1 1 0 012 0zM9 9a1 1 0 000 2v3a1 1 0 001 1h1a1 1 0 100-2v-3a1 1 0 00-1-1H9z"
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" id="title" name="title"
                                ...
                                placeholder="Your project" required value="{{ old('title') }}">
                        </div>
                        <div class="mb-4">
                            <label for="slug"
                        ...
                        <div class="mb-4">
                            <label class="block mb-2 text-sm font-medium text-gray-700 tracking-wide"
                                for="image">Project
                                image</label>
                            <img class="hidden img-preview mb-3 rounded-lg max-w-[410] max-h-[210]">
                            <input type="file"
                            ...
                            <p class="mt-1 md:text-sm text-xs text-secondary" id="image">JPEG, PNG, JFIF or JPG
                                (MIN. 360x360 MAX. 700x360) (MAX SIZE. 1024kb).</p>
                        </div>
                        <div class="mb-4">
                            <label for="body"
                            ...
                            <textarea id="body" name="body" rows="4"
                                class="editor block p-2.5 w-full text-sm text-gray-600 bg-white rounded-lg border border-gray-300 focus:ring-primary focus:border-primary"></textarea>
                        </div>
                        <button type="submit"
